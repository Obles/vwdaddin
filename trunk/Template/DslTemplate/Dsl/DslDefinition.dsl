...
<Dsl dslVersion="1.0.0.0" Id="2ae34dea-c20b-4052-b726-71437291f048" Description="Description for Company.Language1.Language1" Name="Language1" DisplayName="Language1" Namespace="Company.Language1" ProductName="Language1" CompanyName="Company" PackageGuid="9004acc8-aad7-4f4e-b6c8-c0de1a806977" PackageNamespace="Company.Language1" xmlns="http://schemas.microsoft.com/VisualStudio/2005/DslTools/DslDefinitionModel">
  <Classes>
    <DomainClass Id="b313c0b3-f283-437a-a374-fde87590bc92" Description="The root in which all other elements are embedded. Appears as a diagram." Name="ExampleModel" DisplayName="Example Model" Namespace="Company.Language1">
    ...
    <DomainClass Id="9f3c1f2d-1b27-4077-98d5-3a53cf31860e" Description="Elements embedded in the model. Appear as boxes on the diagram." Name="ExampleElement" DisplayName="Example Element" Namespace="Company.Language1">
      <Properties>
        <DomainProperty Id="d76f0fa3-0d9c-4e34-b670-da17edd41266" Description="Description for Company.Language1.ExampleElement.Name" Name="Name" DisplayName="Name" DefaultValue="" IsElementName="true">
          <Type>
  ...
  <Relationships>
    <DomainRelationship Id="6be55444-a397-4568-ac28-99ff42084ade" Description="Embedding relationship between the Model and Elements" Name="ExampleModelHasElements" DisplayName="Example Model Has Elements" Namespace="Company.Language1" IsEmbedding="true">
      <Source>
    ...
    <DomainRelationship Id="6ed734f6-faf2-4e9f-ace8-1890c830b09c" Description="Reference relationship between Elements." Name="ExampleElementReferencesTargets" DisplayName="Example Element References Targets" Namespace="Company.Language1">
      <Source>
        <DomainRole Id="0edeb3ca-e5fe-4267-be91-7895e8afc169" Description="Description for Company.Language1.ExampleRelationship.Target" Name="Source" DisplayName="Source" PropertyName="Targets" PropertyDisplayName="Targets">
          <RolePlayer>
            <DomainClassMoniker Name="ExampleElement" />
          </RolePlayer>
        </DomainRole>
      ...
      <Target>
        <DomainRole Id="26b12250-2f9e-4b80-90f0-3e87caeaa511" Description="Description for Company.Language1.ExampleRelationship.Source" Name="Target" DisplayName="Target" PropertyName="Sources" PropertyDisplayName="Sources">
          <RolePlayer>
            <DomainClassMoniker Name="ExampleElement" />
          </RolePlayer>
        </DomainRole>
  ...
  <Shapes>
    <GeometryShape Id="c9d41d63-f9cd-4e5f-b89e-0e9c98c370d7" Description="Shape used to represent ExampleElements on a Diagram." Name="ExampleShape" DisplayName="Example Shape" Namespace="Company.Language1" FixedTooltipText="Example Shape" FillColor="LightBlue" OutlineColor="" InitialWidth="2" InitialHeight="0.75" Geometry="Rectangle">
  ...
  <Connectors>
    <Connector Id="d0214ce8-d804-4d06-9087-b58b5988443b" Description="Connector between the ExampleShapes. Represents ExampleRelationships on the Diagram." Name="ExampleConnector" DisplayName="Example Connector" Namespace="Company.Language1" FixedTooltipText="Example Connector" DashStyle="Dash" TargetEndStyle="EmptyArrow" />
  </Connectors>
  <XmlSerializationBehavior Name="Language1SerializationBehavior" Namespace="Company.Language1">
    <ClassData>
      ...
      <XmlClassData TypeName="Language1Diagram" MonikerAttributeName="" MonikerElementName="minimalLanguageDiagramMoniker" ElementName="minimalLanguageDiagram" MonikerTypeName="Language1DiagramMoniker">
  ...
  <Diagram Id="96710c2e-5a90-4fcb-af8d-160bb7787c13" Description="Description for Company.Language1.Language1Diagram" Name="Language1Diagram" DisplayName="Minimal Language Diagram" Namespace="Company.Language1">
    <Class>
      <DomainClassMoniker Name="ExampleModel" />
    </Class>
    <ShapeMaps>
  ...
  <Explorer ExplorerGuid="01bdbfd6-3609-4f35-9e11-f166eb678a54" Title="Language1 Explorer">
